...
keywords: postgresql, databases, PostgreSQL Anonymizer, Postgres data masking, GDPR compliance PostgreSQL, Static Masking, Dynamic Masking, Anonymous Dumps, Generalization
...
For more information, see [Anonymous dumps](https://postgresql-anonymizer.readthedocs.io/en/latest/anonymous_dumps/).
{: note}
...
exposing personally identifiable information (PII) or sensitive attributes.
