...
In the UI, on the _Settings_ tab, there is a button to `End connections` to your deployment. Use caution, because it disrupts anything that is connected to your deployment.
