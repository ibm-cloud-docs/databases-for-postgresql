...
- [{{site.data.keyword.loganalysisfull}}](/docs/databases-for-postgresql?topic=cloud-databases-logging)
- [{{site.data.keyword.monitoringfull}}](/docs/databases-for-postgresql?topic=databases-for-postgresql-sysdig-monitoring)
## Settings
