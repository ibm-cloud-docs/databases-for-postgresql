...
- IP Whitelisting - All deployments support [whitelisting IP addresses](/docs/databases-for-postgresql?topic=cloud-databases-whitelisting) to restrict access to the service.
